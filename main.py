...
# Starts the timer by calling the count_down function
def start_timer():
    global reps
    reps += 1
    marks = ""
...
checkmarks_label = Label(fg=GREEN, bg=YELLOW, font=(FONT_NAME, 15, "normal"))
